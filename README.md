...
## Summary 
This is a project that aims to predict the outcome of this year's midterm elections. It takes a number of predictor variables and the results of previous election cycles to predict this one. The models will use logistic regression and are coded in Python.

## Model 1
This model was made using a large database of the average polling data of tossup senate elections from 2014 to 2026. Used factors such as polling averages, incumbency advantages, partisan lean, midterm status, and the party of the president to create a logistic regression model. As of 09/04/2026, this model predicts that Democrats will win in 7 of the 9 tossup senate races. According to this model, Republicans are set to win in Iowa and Alaska, but Democrats will win the other 7 close races including Texas and Ohio. 
