...
## Summary 
This is a project that aims to predict the outcome of this year's midterm elections. It takes a number of predictor variables and the results of previous election cycles to predict this one. 
